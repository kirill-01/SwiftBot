#ifndef SWIFTAPICLIENTBITFINEX_H
...
class SwiftApiClientBitfinex : public SwiftApiClient
{
    Q_OBJECT
public:
    SwiftApiClientBitfinex(QObject* parent = nullptr);
...
private:
    const QString url_pub = "https://api-pub.bitfinex.com";
    const QString url_auth = "https://api.bitfinex.com";

    void auth(QNetworkRequest& req, const QString& api_path, const QString& body_str = "") const;
    QNetworkReply* authPostRequest(const QUrl& url, const QString& api_path, const QString& body_str = "");
};

#endif // SWIFTAPICLIENTBITFINEX_H
