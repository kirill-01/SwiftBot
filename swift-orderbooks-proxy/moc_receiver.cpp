...
QT_MOC_LITERAL(1, 9, 10), // "orderbooks"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4), // "args"
QT_MOC_LITERAL(4, 26, 4), // "rate"
QT_MOC_LITERAL(5, 31, 7), // "pair_id"
QT_MOC_LITERAL(6, 39, 12), // "onOrderBooks"
QT_MOC_LITERAL(7, 52, 11), // "startClient"
QT_MOC_LITERAL(8, 64, 16), // "checkClientState"
QT_MOC_LITERAL(9, 81, 15), // "onClientStarted"
QT_MOC_LITERAL(10, 97, 15), // "QWamp::Session*"
QT_MOC_LITERAL(11, 113, 4) // "sess"

    },
    "Receiver\0orderbooks\0\0args\0rate\0pair_id\0"
    "onOrderBooks\0startClient\0checkClientState\0"
    "onClientStarted\0QWamp::Session*\0sess"
};
...
static const uint qt_meta_data_Receiver[] = {
 ...
 // signals: parameters
    ...
    QMetaType::Void, QMetaType::UInt, QMetaType::Double,    5,    4,
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->rate((*reinterpret_cast< const quint32(*)>(_a[1])),(*reinterpret_cast< const double(*)>(_a[2]))); break;
        case 2: _t->onOrderBooks((*reinterpret_cast< const QVariantList(*)>(_a[1]))); break;
        case 3: _t->startClient(); break;
        case 4: _t->checkClientState(); break;
        case 5: _t->onClientStarted((*reinterpret_cast< QWamp::Session*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Receiver::*)(const QVariantList & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Receiver::orderbooks)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Receiver::*)(const quint32 & , const double & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Receiver::rate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Receiver::orderbooks(const QVariantList & _t1)
{
...
// SIGNAL 1
void Receiver::rate(const quint32 & _t1, const double & _t2)
{
